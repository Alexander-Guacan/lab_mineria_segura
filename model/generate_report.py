...
def generate_html_report(json_file="reports/security_report.json", output_file="reports/security_report.html"):
    """
...
if __name__ == "__main__":
    ...
    report = sys.argv[1] if len(sys.argv) > 1 else "reports/security_report.json"
